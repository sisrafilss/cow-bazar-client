...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: <SingleCow />,
        loader: ({ params }) =>
          fetch(`https://cow-bazar-server-psi.vercel.app/cows/${params.id}`, {
            headers: {
    ...
    children: [
      {
        ...
        loader: () => fetch(`https://cow-bazar-server-psi.vercel.app/cows`),
      },
      {
        ...
        loader: ({ params }) =>
          fetch(`https://cow-bazar-server-psi.vercel.app/user/get/${params._id}`, {
            headers: {
              "Content-Type": "application/json",
              authorization: `Bearer ${token}`,
            },
